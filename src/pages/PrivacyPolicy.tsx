...
const sections = [
  { title: "1. Introduction", content: "ENGPROOF (established 2025, Indore, India) is committed to protecting the privacy and security of your personal information. We adhere to the principles of confidentiality, integrity, and availability in all data processing activities. This Privacy Policy outlines our practices regarding the collection, use, and safeguarding of your data when you engage our technology and security solutions.\n\nWe comply with applicable data protection laws, including the Indian Information Technology Act, 2000, and the General Data Protection Regulation (GDPR) where applicable to our international clients." },
